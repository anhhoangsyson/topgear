    ...
    return (
        <div>
            ...
            <div className='py-24'>
                ...
                <p className='mt-3 text-center font-normal text-xl'>Đọc blogs để hiểu thêm về san pham cua chúng tôi</p>
            </div>
            {/* blogsection */}
                    ...
                    <figure className="p-4 grid grid-cols-1 gap-y-2 rounded-md shadow-md hover:shadow-lg transition-shadow duration-300 py-8">
                        ...
                        <div className="w-11/12 mx-auto pt-4">
                            ...
                            <div className='flex gap-4 mt-2'>
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M7.91473 0.333252C3.67896 0.333252 0.24707 3.76473 0.24707 7.99999C0.24707 12.2352 3.67896 15.6667 7.91473 15.6667C12.1505 15.6667 15.5824 12.2352 15.5824 7.99999C15.5824 3.76473 12.1505 0.333252 7.91473 0.333252ZM7.91473 14.1828C4.49829 14.1828 1.73113 11.416 1.73113 7.99999C1.73113 4.58396 4.49829 1.81714 7.91473 1.81714C11.3312 1.81714 14.0983 4.58396 14.0983 7.99999C14.0983 11.416 11.3312 14.1828 7.91473 14.1828ZM9.82546 10.9554L7.20052 9.04798C7.10468 8.97688 7.04902 8.86559 7.04902 8.74811V3.67199C7.04902 3.46796 7.21598 3.30102 7.42004 3.30102H8.40941C8.61347 3.30102 8.78043 3.46796 8.78043 3.67199V8.05254L10.8457 9.55497C11.0127 9.67554 11.0467 9.9074 10.9261 10.0743L10.3449 10.875C10.2243 11.0389 9.99241 11.076 9.82546 10.9554Z" fill="#4B5563" />
                                </svg>
                                <p className='text-sm font-light'>hời gian: lúc 15:45:52 18/12/2024</p>
                            </div>
                            <div className='mt-2'>
                                <i className='font-light text-sm'>Nội dung: 1. Vietnam Web Summit (VWS) Vietnam Web Summit là sự kiện Công nghệ thường niên được tổ chức bởi</i>
                            </div>
                        </div>
                    </figure>
                    <figure className="p-4 grid grid-cols-1 gap-y-2 rounded-md shadow-md hover:shadow-lg transition-shadow duration-300 py-8">
