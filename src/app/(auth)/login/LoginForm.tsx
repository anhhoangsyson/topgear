...
export default function LoginForm() {
    ...
    return (
        <div className="my-20">
            <form onSubmit={handleSubmit(onSubmit)} className="2xl:w-1/3 max-w-xl mx-auto p-4 border rounded shadow-md bg-white">
                ...
                {/* css spacing */}
                <div className="text-center mx-auto my-4 text-sm font-light text-[#2D88FF]">Or</div>
