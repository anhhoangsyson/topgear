  ...
  <div className="relative z-20">
    ...
    >
      <div>
        ...
        <span className="mt-0.5 text-theme-xs text-gray-500 dark:text-gray-400 max-w-[200px] overflow-hidden text-ellipsis whitespace-nowrap block">
          {session.user?.email || "abc.xyz@gmail.com"}
        </span>
      </div>
