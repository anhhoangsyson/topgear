                ...
                <li key={nav.name}>
                    {nav.subItems ? (
                        <button
                            ...
                            className={`relative flex items-center w-full gap-3 px-3 py-2 font-medium rounded-lg text-theme-sm group  ${openSubmenu?.type === menuType && openSubmenu?.index === index
                        ...
                        nav.path && (
                            <Link
                                href={nav.path}
                                className={`relative flex items-center w-full gap-3 px-3 py-2 font-medium rounded-lg text-theme-sm group ${isActive(nav.path) ? "bg-blue-50 text-blue-500 dark:bg-blue-500/[0.12] dark:text-blue-400" : "text-gray-700 hover:bg-gray-100 group-hover:text-gray-700 dark:text-gray-300 dark:hover:bg-white/5 dark:hover:text-gray-300"
                                    }`}
                            >
                                <span
                                ...
                                {(isExpanded || isHovered || isMobileOpen) && (
                                    <span className={`relative flex items-center w-full gap-3 font-medium rounded-lg text-theme-sm-text`}>{nav.name}</span>
                                )}
                            </Link>
                        )
                    )}
