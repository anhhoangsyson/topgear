...
const imagesAndSeoSchema = z.object({
  images: z.array(z.instanceof(File)).min(1, "Phải có ít nhất 1 hình ảnh"),
...
export default function AddLaptopPage() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/laptop`, {
        method: "POST",
        body: formData,
      })
      ...
      toast({
        ...
        description: `Laptop "${data.name}" đã được tạo.`,
      });
      ...
      toast({
        variant: "destructive",
        title: "Có lỗi xảy ra",
        description: "Không thể tạo laptop. Vui lòng thử lại sau.",
      });
    } finally {
            ...
            <CardContent>
              ...
              <Tabs value={activeTab} onValueChange={handleTabChange}>
                ...
                <TabsContent value="images">
                  <ImagesAndSeoForm suggestedMetadata={suggestedMetadata} />
                </TabsContent>
